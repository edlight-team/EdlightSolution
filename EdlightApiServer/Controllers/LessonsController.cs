...
namespace EdlightApiServer.Controllers
{
    ...
    {
        private readonly Lessons db;
        public LessonsController() => db = new();
        ...
        public object Get([FromHeader] string id, [FromHeader] string condition)
        {
            try
            {
                ...
                {
                    LessonsModel model = db.GetModels().FirstOrDefault(m => m.Id == new Guid(id));
        ...
        [HttpPost]
        public object Post([FromBody] LessonsModel model)
        {
        ...
        [HttpPut]
        public object Put([FromBody] LessonsModel model)
        {
            try
            {
