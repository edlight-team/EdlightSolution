...
namespace EdlightApiServer.Controllers
{
    ...
    {
        private readonly Permissions db;
        public PermissionsController() => db = new();
        ...
        public object Get([FromHeader] string id, [FromHeader] string condition)
        {
            try
            {
                ...
                {
                    PermissionsModel model = db.GetModels().FirstOrDefault(m => m.Id == new Guid(id));
        ...
        [HttpPost]
        public object Post([FromBody] PermissionsModel model)
        {
        ...
        [HttpPut]
        public object Put([FromBody] PermissionsModel model)
        {
            try
            {
