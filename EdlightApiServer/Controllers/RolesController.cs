...
namespace EdlightApiServer.Controllers
{
    ...
    {
        private readonly Roles db;
        public RolesController() => db = new();
        ...
        public object Get([FromHeader] string id, [FromHeader] string condition)
        {
            try
            {
                ...
                {
                    RolesModel model = db.GetModels().FirstOrDefault(m => m.Id == new Guid(id));
        ...
        [HttpPost]
        public object Post([FromBody] RolesModel model)
        {
        ...
        [HttpPut]
        public object Put([FromBody] RolesModel model)
        {
            try
            {
