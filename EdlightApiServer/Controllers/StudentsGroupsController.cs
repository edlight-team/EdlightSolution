...
namespace EdlightApiServer.Controllers
{
    ...
    {
        private readonly StudentsGroups db;
        public StudentsGroupsController() => db = new();
        ...
        public object Get([FromHeader] string id, [FromHeader] string condition)
        {
            try
            {
                ...
                {
                    StudentsGroupsModel model = db.GetModels().FirstOrDefault(m => m.Id == new Guid(id));
        ...
        [HttpPost]
        public object Post([FromBody] StudentsGroupsModel model)
        {
        ...
        [HttpPut]
        public object Put([FromBody] StudentsGroupsModel model)
        {
            try
            {
