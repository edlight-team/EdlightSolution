...
namespace EdlightApiServer.Controllers
{
    ...
    [ApiController]
    public class TimeLessonsController : ControllerBase
    {
        private readonly TimeLessons db;
        public TimeLessonsController() => db = new();
        ...
        public object Get([FromHeader] string id, [FromHeader] string condition)
        {
            try
            {
                ...
                {
                    TimeLessonsModel model = db.GetModels().FirstOrDefault(m => m.Id == new Guid(id));
        ...
        [HttpPost]
        public object Post([FromBody] TimeLessonsModel model)
        {
        ...
        [HttpPut]
        public object Put([FromBody] TimeLessonsModel model)
        {
            try
            {
