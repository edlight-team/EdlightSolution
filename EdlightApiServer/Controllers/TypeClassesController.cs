...
namespace EdlightApiServer.Controllers
{
    ...
    {
        private readonly TypeClasses db;
        public TypeClassesController() => db = new();
        ...
        public object Get([FromHeader] string id, [FromHeader] string condition)
        {
            try
            {
                ...
                {
                    TypeClassesModel model = db.GetModels().FirstOrDefault(m => m.Id == new Guid(id));
        ...
        [HttpPost]
        public object Post([FromBody] TypeClassesModel model)
        {
        ...
        [HttpPut]
        public object Put([FromBody] TypeClassesModel model)
        {
            try
            {
