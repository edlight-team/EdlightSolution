...
namespace EdlightApiServer.Controllers
{
    ...
    [ApiController]
    public class UsersDialogsController : ControllerBase
    {
        private readonly UsersDialogs db;
        public UsersDialogsController() => db = new();
        ...
        public object Get([FromHeader] string id, [FromHeader] string condition)
        {
            try
            {
                ...
                {
                    UsersDialogsModel model = db.GetModels().FirstOrDefault(m => m.Id == new Guid(id));
        ...
        [HttpPost]
        public object Post([FromBody] UsersDialogsModel model)
        {
        ...
        [HttpPut]
        public object Put([FromBody] UsersDialogsModel model)
        {
            try
            {
