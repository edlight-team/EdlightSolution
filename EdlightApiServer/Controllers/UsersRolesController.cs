...
namespace EdlightApiServer.Controllers
{
    ...
    {
        private readonly UsersRoles db;
        public UsersRolesController() => db = new();
        ...
        public object Get([FromHeader] string id, [FromHeader] string condition)
        {
            try
            {
                ...
                {
                    UsersRolesModel model = db.GetModels().FirstOrDefault(m => m.Id == new Guid(id));
        ...
        [HttpPost]
        public object Post([FromBody] UsersRolesModel model)
        {
        ...
        [HttpPut]
        public object Put([FromBody] UsersRolesModel model)
        {
            try
            {
